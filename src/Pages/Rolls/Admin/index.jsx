      ...
      <AdminContainer>
        <div className="nav">
          <div className="items">
            {
              nav.map((v) => {
                return <p onClick={() => setPage(v.page)} className={`child ${page === v.page ? "active" : ''}`}>
                  {v.name}
                </p>
              })
            }
                ...
                {ctgs.map((v) => {
                  return (
                    ...
                    >
                      ...
                      <p onClick={() => DelCtg(v.id)} className="rightfixed fa-solid fa-trash"></p>
                  ...
                  {users.map((v) => {
                    return (
                      ...
                      >
                        ...
                        <p className="">{v.pass === 'undefined' ? "Google orqali" : v.pass.slice(26, v.pass.length)}</p>
