      ...
      <Container>
        ...
        <BookInformation>
          <div className="first">
            ...
            <div className="text-[20px]"> <span>Muallif:</span>  {BookCurrent?.muallif}</div>
            <div className="text-[20px]"> <span>chiqgan yili:</span> {BookCurrent?.year}</div>
            <div className="text-[20px]"> <span>Nashriyot:</span> {BookCurrent?.nashriyot}</div>
            <div className="text-[20px]"> <span>kategoriya:</span> {getCategory(BookCurrent?.ctg)}</div>
            ...
            <div className="flex gap-[20px]">
              ...
              {user?.type === "nazoratchi" && BookCurrent?.hidden ? (
                <ButtonLink onClick={AcceptBook} className="bg-slate-700 hover:bg-slate-600 button"
                >
                  Ruhsat berish
                </ButtonLink>
              ) : (
